...
def get_args():
    ...
    description = "split ICESat-2 ATL06 data files by groud track and orbit."
...
if __name__ == '__main__':
    ...
    if njobs == 1:
        ...
        [split_atl06(f, dir_out) for f in ifiles]
    else:
        print(("running in parallel (%d jobs) ..." % njobs))
        from joblib import Parallel, delayed
        Parallel(n_jobs=njobs, verbose=5)(
                delayed(split_atl06)(f, dir_out) for f in ifiles)
